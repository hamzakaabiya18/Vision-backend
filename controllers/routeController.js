...
const SEED_ROUTES = [
  { title:'Carmel Morning Run',       sportType:'Run',  city:'Haifa',     country:'Israel', distanceKm:8.4,  estimatedDurationMinutes:48,  elevationGainM:180, difficulty:'moderate', imageUrl:'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=700&q=80', description:'A scenic run along the Carmel ridge with sea views and shaded forest trail sections.', popularityScore:92, tags:['scenic','forest'] },
  ...
  { title:'Yokneam Forest Trail',     sportType:'Hike', city:'Yokneam',   country:'Israel', distanceKm:11.6, estimatedDurationMinutes:210, elevationGainM:420, difficulty:'hard',     imageUrl:'https://images.unsplash.com/photo-1551632811-561732d1e306?w=700&q=80', description:'Technical forest singletrack with a steady climb through pine woodland.', popularityScore:74, tags:['forest','technical'] },
  ...
  { title:'Tel Aviv Promenade Run',   sportType:'Run',  city:'Tel Aviv',  country:'Israel', distanceKm:9.8,  estimatedDurationMinutes:52,  elevationGainM:20,  difficulty:'easy',     imageUrl:'https://images.unsplash.com/photo-1486218119243-13883505764c?w=700&q=80', description:'Flat beachfront promenade run with consistent footing, popular at sunrise.', popularityScore:95, tags:['beach','flat'] },
  ...
  { title:'Jerusalem Hills Climb',    sportType:'Ride', city:'Jerusalem', country:'Israel', distanceKm:38.4, estimatedDurationMinutes:105, elevationGainM:780, difficulty:'hard',     imageUrl:'https://images.unsplash.com/photo-1471506480208-91b3a4cc78be?w=700&q=80', description:'A demanding climb through the Jerusalem hills, popular with serious cyclists.', popularityScore:70, tags:['climb','hills'] },
  { title:'Old City Walking Tour',    sportType:'Walk', city:'Jerusalem', country:'Israel', distanceKm:5.2,  estimatedDurationMinutes:70,  elevationGainM:90,  difficulty:'easy',     imageUrl:'https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=700&q=80', description:'Wander the historic alleys at an easy pace — light effort, rich scenery.', popularityScore:60, tags:['historic','easy'] },
  ...
  { title:'Yokneam Sprint Loop',      sportType:'Run',  city:'Yokneam',   country:'Israel', distanceKm:5.0,  estimatedDurationMinutes:24,  elevationGainM:60,  difficulty:'moderate', imageUrl:'https://images.unsplash.com/photo-1486218119243-13883505764c?w=700&q=80', description:'A short fast loop ideal for interval and tempo sessions.', popularityScore:54, tags:['speed','loop'] },
]
